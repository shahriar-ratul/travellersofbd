      ...
      <div class="container">
        <div class="row">
          ...
          <div class="post col-xl-6">
            <div class="post-thumbnail"><a href="#"><img src="{{asset('/blog/img/blog-post-1.jpeg')}}" alt="..." class="img-fluid"></a></div>
...
<!-- JavaScript files-->
 ...
 <script src="{{asset('/blog/vendor/popper.js/umd/popper.min.js')}}"> </script>
